...
const OAuthConfiguration = dist.iface([], {
    "clientId": "string",
    "resource": "string",
    "oAuthUri": "string",
    "tokenUri": "string",
...
const { OAuthConfigurationChecker } = dist.createCheckers(exportedTypeSuite);
class OAuthConfiguration$1 {
...
const AppSwitcher = (props) => {
    ...
    const loadConfig = () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (response.status === 200) {
            const data = yield response.json();
            const config = new OAuthConfiguration$1(data); //validates the configuration and throws a VError if it fails

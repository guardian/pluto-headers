    ...
    render() {
        if(this.state.hasError) {
            ...
            return (
                <div className="breadcrumb-container">
                    {
                        this.state.commissionName=="" ? null : <div className="breadcrumb">
                            <img className="breadcrumb-icon" src={`data:image.png;base64/${iconCommission}`} alt="Commission"/>
                            <Typography>{this.state.commissionName}</Typography>
                        </div>
                    }
                    {
                        this.state.projectName=="" ? null : <div className="breadcrumb">
                            <img className="breadcrumb-icon" src="/static/icon/project.png" alt="Project"/>
                            <Typography>{this.state.projectName}</Typography>
                        </div>
                    }
                    {
                        this.state.masterName=="" ? null : <div className="breadcrumb">
                            <img className="breadcrumb-icon" src="/static/icon/master.png" alt="Master"/>
